...
public class shopingMallUserController {
    ...
    public String usersPage(HttpServletRequest request) {
        ...
        return "admin/shoping_mall_user";
    }
    ...
    public Result list(@RequestParam Map<String, Object> params) {
        ...
        return ResultGenerator.genSuccessResult(shopingMallUserService.getshopingMallUsersPage(pageUtil));
    }
    ...
    public Result delete(@RequestBody Integer[] ids, @PathVariable int lockStatus) {
        ...
        if (shopingMallUserService.lockUsers(ids, lockStatus)) {
